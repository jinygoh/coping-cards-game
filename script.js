document.addEventListener('DOMContentLoaded', () => {
    ...
    const decks = {
        ...
        "Workplace Woes": [
            "You made a major mistake on a project that you are responsible for.",
            "You have a coworker who is constantly taking credit for your ideas.",
            "You are feeling bored and unmotivated in your current role.",
            "You are dealing with a difficult boss who is never satisfied with your work.",
            "You are feeling overwhelmed with your workload and are struggling to meet deadlines.",
            "You are feeling undervalued and unappreciated for your contributions.",
            "You are dealing with a toxic work environment where there is a lot of gossip and negativity.",
            "You are feeling like you are not growing or developing in your current role.",
            "You are feeling anxious about a big presentation or meeting.",
            "You are struggling to balance your work and personal life."
        ],
        "Relationship Riddles": [
            "You are feeling disconnected from your partner and are not sure how to reconnect.",
            "You are having the same argument with your partner over and over again.",
            "You are feeling like you are not being heard or understood by your partner.",
            "You are struggling to trust your partner after they have betrayed your trust.",
            "You are feeling like you are not on the same page as your partner about your future together.",
            "You are dealing with a jealous or controlling partner.",
            "You are feeling like you are not getting your needs met in your relationship.",
            "You are struggling to communicate effectively with your partner.",
            "You are feeling like you are not compatible with your partner.",
            "You are feeling like you are not in love with your partner anymore."
        ],
        "Creative Crises": [
            "You are feeling completely blocked and are not able to come up with any new ideas.",
            "You are feeling like your work is not good enough and are struggling with self-doubt.",
            "You are feeling uninspired and are not sure how to get your creative juices flowing.",
            "You are feeling like you are not making any progress in your creative pursuits.",
            "You are feeling like you are not talented enough to be successful.",
            "You are feeling like you are not being recognized for your creative work.",
            "You are feeling like you are not being supported by your friends or family in your creative endeavors.",
            "You are feeling like you are not being true to your own creative vision.",
            "You are feeling like you are not being challenged enough in your creative work.",
            "You are feeling like you are not being able to make a living from your creative work."
        ]
    };

    let currentDeck = decks["General"];
    ...
    buttons.drawCard.addEventListener('click', () => {
        if (drawnCards.length === currentDeck.length) {
